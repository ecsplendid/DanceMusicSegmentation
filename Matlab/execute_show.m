...
chopper =  true( size( audio_low ) ) ;
    ...
    [ avg_shift, matched_tracks_fft, predictions, SC, C, W, w, space ] = ...
        process_wavfile( showname, sampleRate, indexes, audio_low, secondsPerTile, ...
            ...
            use_costsymmetry, use_costcontig, use_costsum, use_costgaussian, use_costgaussianwidth, ...
               ...
            costcontig_incentivebalance, costsum_incentivebalance, ...
            costsymmetry_incentivebalance, costgauss_incentivebalance, ...
            use_cosinecache );
